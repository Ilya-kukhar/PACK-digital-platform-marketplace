...
**Название**: Цифровая платформа логистики

**Описание**: Предметная область ИТ-систем, цифровых двойников, ИИ-агентов и архитектурных паттернов, применяемых в логистике маркетплейса. Включает архитектуру цифрового двойника посылки, методы SLA-мониторинга, ИИ-системы и SOTA-паттерны.
...
- SOTA-методы для IT-слоя логистической платформы
- Паттерны хранения и обработки событий посылки
